        ...
        {currentUser ? (
          <>
            ...
            >
              ...
              <MenuItem onClick={() => { handleMenuClose(); navigate('/pedidos'); }} data-testid="my-orders-link">
                Mis Pedidos
              </MenuItem>
              <MenuItem onClick={handleLogout} data-testid="logout-button">Cerrar Sesión</MenuItem>
            </Menu>
          </>
        ) : (
          <>
